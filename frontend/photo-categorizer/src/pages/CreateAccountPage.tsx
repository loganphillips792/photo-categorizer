...
const CreateAccountPage: React.FC = () => {
    ...
    const handleCreateAccount = useCallback(
        async (event: React.FormEvent<HTMLFormElement>) => {
            ...
            try {
                ...
                if (!loginResponse.ok) {
                    ...
                    throw new Error(
                        loginData.error ||
                            `Registration successful, but auto-login failed: ${loginResponse.statusText}. Please log in manually.`,
                    );
                }
        ...
        [username, email, password, confirmPassword, navigate, auth],
    ); // Add auth to dependencies
